...
class FCM(nn.Module):
    ...
    def forward(self, x):
        return F.relu(self.bn2(self.conv2(self.layer2(self.layer1(F.relu(self.bn1(self.conv1(x)))))))).reshape(1, 320, -1)
...
class CAMPPlus(nn.Module):
    ...
    def forward(self, x):
        return self.xvector(self.head(x.unsqueeze(0))).transpose(1, 2)
