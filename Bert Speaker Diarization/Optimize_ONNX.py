...
# Path Setting
original_folder_path = r"/home/DakeQQ/Downloads/Bert_Speaker_Diarization_ONNX"              # The original float32 exported model folder.
quanted_folder_path = r"/home/DakeQQ/Downloads/Bert_Speaker_Diarization_Optimized"          # The optimized folder.
...
model_path = os.path.join(original_folder_path, "Bert_Speaker_Diarization.onnx")            # The original fp32 model path.
quanted_model_path = os.path.join(quanted_folder_path, "Bert_Speaker_Diarization.onnx")     # The optimized model stored path.
