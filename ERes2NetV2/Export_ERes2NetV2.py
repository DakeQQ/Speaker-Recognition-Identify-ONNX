...
class ERES2NETV2(torch.nn.Module):
    def __init__(self, eres2netv2, stft_model, nfft_stft, nfft_fbank, stft_signal_len, n_mels, sample_rate, pre_emphasis):
...
with torch.inference_mode():
    ...
    eres2netv2 = ERES2NETV2(model, custom_stft, NFFT_STFT, NFFT_FBANK, STFT_SIGNAL_LENGTH, N_MELS, SAMPLE_RATE, PRE_EMPHASIZE)
